...
<!-- Mirrored from preview.colorlib.com/theme/chariter/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Dec 2021 09:48:08 GMT -->
<head>
<meta charset="utf-8">
...
<link rel="shortcut icon" type="image/x-icon" href="{{url('frontend/img/icon/xfavicon.png.pagespeed.ic.nmRVxKPWWY.png')}}">

<link rel="stylesheet" href="{{url('frontend/css/A.bootstrap.min.css%2bowl.carousel.min.css%2bslicknav.css%2bprogressbar_barfiller.css%2banimate.min.css%2bmagnific-popup.css%2bfontawesome-all.min.css%2bthemify-icons.css')}}" />
<link rel="stylesheet" href="{{url('frontend/css/A.style.css.pagespeed.cf.4BNA0tOFq8.css')}}">
</head>
<body>
<header>
...
<li><a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ed84838b82c3d4ddad8e858c9f8499889fc38e8280">[email&#160;protected]</a></li>
</ul>
</div>
...
<div class="logo">
<a href="index-2.html"><img src="{{url('frontend/img/logo/xlogo.png.pagespeed.ic.-zC6wJ44IE.png')}}" alt=""></a>
</div>
</div>
...
<a href="#"><img src="{{url('frontend/img/gallery/xservices-img1.jpg.pagespeed.ic.z3Y9sLcGL6.jpg')}}" alt=""></a>
...
<div class="properties-card">
<div class="properties-img">
<a href="#"><img src="{{url('frontend/img/gallery/xservices-img2.jpg.pagespeed.ic.EXilv0AeCt.jpg')}}" alt=""></a>
...
<div class="properties-card">
<div class="properties-img">
<a href="#"><img src="{{url('frontend/img/gallery/xservices-img3.jpg.pagespeed.ic.GHN89oFjlK.jpg')}}" alt=""></a>
...
<img src="{{url('frontend/img/gallery/about.jpg')}}" alt="">
</div>
</div>
...
<div class="count-down-area pt-25 section-img-bg2" data-background="{{url('frontend/img/gallery/section-bg1.jpg')}}">
<div class="container">
<div class="row justify-content-center">
...
<img src="{{url('frontend/img/icon/count-icon1.svg')}}" alt="">
</div>
<div class="captions">
...
<div class="single-counter d-flex align-items-center">
<div class="counter-img">
<img src="{{url('frontend/img/icon/count-icon2.svg')}}" alt="">
</div>
<div class="captions">
...
<div class="single-counter d-flex align-items-center">
<div class="counter-img">
<img src="{{url('frontend/img/icon/count-icon3.svg')}}" alt="">
</div>
<div class="captions">
...
<div class="single-counter d-flex align-items-center">
<div class="counter-img">
<img src="{{url('frontend/img/icon/count-icon4.svg')}}" alt="">
</div>
<div class="captions">
...
<img src="{{url('frontend/img/icon/services1.svg')}}" alt="">
</div>
...
<div class="single-services text-center mb-30">
<div class="services-icon">
<img src="{{url('frontend/img/icon/services2.svg')}}" alt="">
</div>
<div class="services-cap">
...
<div class="emargency-care section-img-bg2" data-background="{{url('frontend/img/gallery/section-bg2.jpg')}}">
<div class="container">
<div class="row justify-content-end">
...
<img src="{{url('frontend/img/gallery/joining1.jpg')}}" alt="" class="w-100">
</div>
</div>
<div class="col-xl-3 col-lg-3 col-md-5 col-sm-5">
<div class="joning-img">
<img src="{{url('frontend/img/gallery/xjoining2.jpg.pagespeed.ic.JgVV0eNxwV.jpg')}}" alt="" class="w-100">
</div>
</div>
</div>
</div>
...
<a href="index-2.html"><img src="{{url('frontend/img/logo/xlogo2_footer.png.pagespeed.ic._vjAlOijmU.png')}}" alt=""></a>
</div>
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{('frontend/js/vendor/modernizr-3.5.0.min.js')}}"></script>
<script src="{{url('frontend/js/vendor/jquery-1.12.4.min.js')}}"></script>
<script src="{{url('frontend/js/popper.min.js%2bbootstrap.min.js.pagespeed.jc.7ZEwLWHZTy.js')}}"></script><script>eval(mod_pagespeed_pgiy9PVHjW);</script>
<script>eval(mod_pagespeed_7d9OhKA4kK);</script>

<script src="{{url('frontend/js/owl.carousel.min.js%2bslick.min.js.pagespeed.jc.z44RYevO2W.js')}}"></script><script>eval(mod_pagespeed_vSq$GL4wKU);</script>
<script>eval(mod_pagespeed_ut$3uU40a3);</script>
<script src="{{url('frontend/js/jquery.slicknav.min.js%2bwow.min.js%2bjquery.magnific-popup.js%2bjquery.nice-select.min.js%2bjquery.counterup.min.js%2bwaypoints.min.js%2bbarfiller.js%2bcontact.js.pagespe')}}"></script><script>eval(mod_pagespeed_DNMk9jRGaw);</script>

<script>eval(mod_pagespeed_T645bhQwP7);</script>
<script>eval(mod_pagespeed_RSaO4Ojttb);</script>
<script>eval(mod_pagespeed_AxGvccCyNv);</script>
<script>eval(mod_pagespeed_OabdW2f19j);</script>
<script>eval(mod_pagespeed_2GjGkVVDVL);</script>
<script>eval(mod_pagespeed_CH4S22uUZD);</script>

<script>eval(mod_pagespeed_7AG3TbPysz);</script>
<script src="{{('frontend/js/jquery.form.js%2bjquery.validate.min.js%2bmail-script.js%2bjquery.ajaxchimp.min.js%2bplugins.js%2bmain.js.pagespeed.jc.pJTL9mubPs.js')}}"></script><script>eval(mod_pagespeed_hEaY$ftpYV);</script>
<script>eval(mod_pagespeed_SblYXaJ4Je);</script>
<script>eval(mod_pagespeed_4v4rW7W66w);</script>
<script>eval(mod_pagespeed_mJJxJCElgy);</script>

<script>eval(mod_pagespeed_TeOg33fy6_);</script>
<script>eval(mod_pagespeed_3yO8i0QV8x);</script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v64f9daad31f64f81be21cbef6184a5e31634941392597" integrity="sha512-gV/bogrUTVP2N3IzTDKzgP0Js1gg4fbwtYB6ftgLbKQu/V8yH2+lrKCfKHelh4SO3DPzKj4/glTO+tNJGDnb0A==" data-cf-beacon='{"rayId":"6b6b65e61e0549d8","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.11.0","si":100}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/chariter/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Dec 2021 09:48:20 GMT -->
</html>